...
const DatabaseRepository = {
  ...
  async createCustomer(customer) {
    ...
    const created = await db.query(
      "INSERT INTO customer (id, name, address, telephone, expiry_date, business_category, service, key_person_name, key_person_dob, key_person_hp, created_at, email, birth_date, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
      [
        id,
        name,
        address,
